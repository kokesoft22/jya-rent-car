...
const AddExpenseModal = ({ isOpen, onClose, vehicles }) => {
            ...
            <div className="modal-content glass-card">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="modal-form">
                    <div className="form-group">
                        ...
                        <input type="text" className="input-field" placeholder="Cambio de aceite..." {...register('description')} />
                        {errors.description && <span className="error-text text-danger">{errors.description.message}</span>}
                    </div>
                    <div className="form-row">
                        <div className="form-group">
                            <label>Monto ($)</label>
                            <input type="number" className="input-field" placeholder="150" {...register('amount')} />
                            {errors.amount && <span className="error-text text-danger">{errors.amount.message}</span>}
                        </div>
                        <div className="form-group">
